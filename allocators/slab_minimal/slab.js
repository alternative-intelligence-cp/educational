 ...
 * 
 * NOTE: This file has been superseded by two separate implementations:
 *   - slab_linear.js   (this original version - linear search, lazy allocation)
 *   - slab_freelist.js (optimized version - free list, O(1) operations)
 *   - benchmark.js     (performance comparison)
 * 
 * Run `node slab_linear.js` or `node slab_freelist.js` for examples.
 * Run `node benchmark.js` to compare performance.
 * 
